  ...
  return (
    <div className="flex w-full flex-col items-center  gap-10 py-20 text-slate-600">
      ...
      <p className="w-5/6 text-justify text-xs sm:w-1/2 sm:text-base">
        ...
        business in 2005. Over time, this venture evolved into a comprehensive
        M&E company, before transitioning to specialize in providing top-tier
        designs for electrical contractors and clients.
        <br />
